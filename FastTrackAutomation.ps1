...
<#
$x = Get-AzADServicePrincipal -DisplayName "sp-canaldenuncias-001-dev"
$xID = $x.Id
Write-Host "`n $xID n"
---------------
$env = "DEV"
...
# Criar SP
$spName = "sp-$($Keyword.ToLower())-001-$env"
$sp = New-AzADServicePrincipal -DisplayName $spName -Scope "/subscriptions/$subId/resourceGroups/$rgName"
$sp
$spId = $sp.Id
...
# Grupos
$groupSuffixes = @("ApplicationOwner", "DevLead", "Readers", "Support", "TechLead", "ElevatedAcsTechLead", "ElevatedAcsSupport", "IaCDeveloper", "IaCSupport", "IaCSupportApprover")
$groupSuffixesOwnerVale = @("ApplicationOwner", "DevLead", "Readers", "TechLead", "IaCDeveloper", "IaCSupport", "IaCSupportApprover")
